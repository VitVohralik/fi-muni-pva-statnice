...
> **Impact pyramid:** čím výše v softwarovém stacku (od koncových uživatelů přes administrátory, vývojáře aplikací a knihoven až po vývojáře OS), tím menší počet lidí, ale tím větší dopad jejich rozhodnutí. Použitelnost je proto **ještě důležitější pro IT profesionály** — jejich chyba se propaguje na všechny pod nimi.
